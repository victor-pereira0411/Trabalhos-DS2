    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            ...
            <ul class="list-unstyled px-2">
                <li class="active"><a href="index.php" class="text-decoration-none px-3 py-2 d-block"><i class="fal fa-home"></i>Painel</a></li>
                ...
                <div class="nav container-fluid p-0 justify-content-end">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modalusuarios">
                                    Gerenciar cadastro
                                </button>
